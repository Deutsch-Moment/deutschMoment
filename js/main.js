...
const certificates = {
  ...
  "DM-B1-2025-MS0019": {
    id: "DM-B1-2025-MS0019",
    studentName: "Mohammad Ali Skandari",
    level: "B1",
    grade: "297/400",
    completionDate: "December 28, 2025",
    issueDate: "January 7 2026",
    verifiedDate: "1/7/2026",
    isValid: true,
  },
  "DM-A1-2026-SA0022": {
    id: "DM-A1-2026-SA0022",
    studentName: "Shukria Amiri",
    level: "A1",
    grade: "80/100",
    completionDate: "April 5, 2026",
    issueDate: "April 10, 2026",
    verifiedDate: "4/10/2026",
    isValid: true,
  },
};
...
cards.forEach((card) => {
  card.addEventListener("click", (e) => {
    ...
    const btn = e.target;
    const isCurrentlyOpen = currentDetails.classList.contains(
